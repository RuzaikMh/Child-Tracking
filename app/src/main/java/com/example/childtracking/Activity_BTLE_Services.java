...
public class Activity_BTLE_Services extends AppCompatActivity implements ExpandableListView.OnChildClickListener {
    ...
    public static final String EXTRA_NAME = "com/example/childtracking/Activity_BTLE_Services.NAME";
    public static final String EXTRA_ADDRESS = "com/example/childtracking/Activity_BTLE_Services.ADDRESS";
    private static final String TAG = Activity_BTLE_Services.class.getSimpleName();
